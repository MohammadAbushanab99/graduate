...
Widget actionBarRow(Color color) {
...
Widget searchTextField(Color color) {
  return Row(
    ...
    children: <Widget>[
        ...
        child: TextField(
          ...
          decoration: new InputDecoration(
            ...
            border: OutlineInputBorder(
              ...
              borderSide: new BorderSide(color: Colors.grey.shade300, width: 0.5),
            ),
          ),
        ),
      ),
      Container(
        ...
        child: Icon(FontAwesomeIcons.bell, size: 26,color: color,),
      )
    ],
  );
}
